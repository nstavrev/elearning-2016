export var COURSES = [{
    ...
    courseTitle : "Въведение в Angular2",
    annotation : {
        text : [
            ...
            "Прилагане на конкретно технологични решения за пълноценна уеб разработка посредством Angular2",
            "Реализиране на собствено уеб, мобилно или настролно приложение",
            "Курсът е предназванчен за хора с основни познания по HTML, CSS, JavaScript.",
            "Самостоятелна подготовка за курсовите задачи",
            "Присъствие на лекции и упражнения",
            "Материалът е разпределен равномерно в съразмерни теми.",
            "Стартира с базови за технологията концепции и завършва с напреднали техники за",
            "пълноценна уеб разработка посредством Angular2.",
            "Предвиденото време за обучение е 14 седмици"
        ]
    },
    content : [
        {
